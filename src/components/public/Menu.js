  ...
  render () {
    return (
      ...
      <div className='space-70' />
            <div className="row menu-filter-items">
                <div className=" start breakfast col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image1.jpg" data-lightbox="gallery">
                        <img src="/assets/images/image1.jpg" alt="" className="img-fluid"/>
                ...
                <div className=" dinner lunch col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image2.jpg" data-lightbox="gallery">
                        <img src="/assets/images/image2.jpg" alt="" className="img-fluid"/>
                        <div className="gallery-overlay">
                            <span className="ion-ios-plus-empty"></span>
                        </div>
                        <div className="menu-grid-desc">                               
                ...
                <div className=" dinner start col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image5.jpg" data-lightbox="gallery">
                ...
                <div className=" breakfast col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image6.jpg" data-lightbox="gallery">
                ...
                <div className=" start dinner col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image9.jpg" data-lightbox="gallery">
                ...
                <div className=" start breakfast col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image10.jpg" data-lightbox="gallery">
...
with a sweet, tangy savory sauce.
                            </p>
                        </div>                           
                    </a>
                </div>
                <div className=" start breakfast col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image11.jpg" data-lightbox="gallery">
...
tangy, spicy, savoury sauce.
                            </p>
                        </div>                           
                    </a>
                </div>
                <div className=" start breakfast col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image21.jpg" data-lightbox="gallery">
                ...
                <div className=" start lunch col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image8.jpg" data-lightbox="gallery">
...
in pearl pieces, cooked with a
scrumptious tomato sauce with
beef and vegetables
                            </p>
                        </div>                           
                    </a>
                ...
                <div className=" breakfast lunch col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image14.jpg" data-lightbox="gallery">
                        <img src="/assets/images/image14.jpg" alt="" className="img-fluid"/> <div className="gallery-overlay"> 
                                                    <span className="ion-ios-plus-empty"></span>                         </div>
                        <div className="menu-grid-desc">                               
                            <span className="price float-right">$12.99</span>
                            <h4>Kung Pao Chicken</h4>
                            <p>
                                Chicken and vegetabeles fried with peanuts and served with rice.
                            </p>
                        </div>                           
                    </a>
                </div>
                ...
                <div className=" breakfast col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image16.jpg" data-lightbox="gallery">
                ...
                <div className=" dinner start col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image17.jpg" data-lightbox="gallery">
...
with a family recipe ( 3 skewers)
                            </p>
                        </div>                           
                    </a>
                </div>
                ...
                <div className=" start dinner col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image19.jpg" data-lightbox="gallery">
                ...
                <div className=" start breakfast col-md-4 margin-b-30 menu-item">
                    <a className="menu-grid gallery-box" href="/assets/images/image20.jpg" data-lightbox="gallery">
...
layer of simmering meat, carrots, currants,
and onions.
                            </p>
                        </div>                           
                    </a>
